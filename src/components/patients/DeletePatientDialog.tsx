...
export function DeletePatientDialog({ patient, open, onOpenChange, onDelete }: DeletePatientDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        className="relative z-10 w-full max-w-110 rounded-2xl border border-[#e5edf5] bg-white p-6 animate-in fade-in zoom-in-95 duration-200"
      ...
      >
        ...
        <div className="space-y-2 mb-5">
          {patient.totalVisits > 0 && (
            <div className="flex items-center gap-2 rounded-md bg-[#FFF8E1] px-3 py-2">
        ...
        {error && (
          <div className="mb-4 rounded-md border border-[#DF1B41]/20 bg-[#FDE8EC] px-3 py-2">
        ...
        <div className="flex justify-end gap-2">
          <Button
            ...
            variant="outline"
            onClick={() => onOpenChange(false)}
            className="h-8 px-3 text-[15px] font-medium rounded-md border-[#e5edf5] text-[#273951] hover:bg-[#f6f9fc]"
          >
            Cancel
          </Button>
          <Button
            ...
            disabled={deleting}
            className="h-8 px-3 text-[15px] font-medium rounded-md bg-[#df1b41] hover:bg-[#c4183c] text-white transition-all duration-200"
          >
